...
from tphenotype.utils import select_by_steps, get_one_hot, data_split
...
considered= ['APOE4','Hippocampus','CDRSB',]
...
_,x_orig, _,range_m = cut_windowed_data(data_t, data_x_orig, data_y, data_mask,window_size=window_size,range_mask=True)
